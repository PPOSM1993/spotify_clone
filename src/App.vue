  ...
  <div class="">
    <div 
      ...
      <div class=""flex items-center ml-6>
        <button type="button" class="rounded-full bg-black p-[10px] cursor-pointer">
      ...
      @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items center">
          <img 
            class="rounded-full" 
            width="27"
            src="https://yt3.ggpht.com/yti/ANjgQV9EdxJr3m4XSLIo2-QmNWRDaP7VWFkyJcDIh-Do3L2he_A=s88-c-k-c0x00ffffff-no-rj"
          >
          <div class="text-white text-[14px] ml-1.5 font-semibold"> Pedro Pablo Osorio San Martin</div>
    ...
    <div id="SideNav" class="h-[100%] p-6 w-[240px] fixed z-50 bg-black">
      ...
      <div class="my-8"></div>
        ...
        <div class="border-b border-b-gray-700"></div>
            <ul>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">Country List</li>
                <li class="font-semibold text-[13px] mt-3 text-gray-300 hover:text-white">One Tree Hill</li>
